<?php /*a:6:{s:84:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\apply\graduate_student.html";i:1556191104;s:80:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_head.html";i:1553677718;s:79:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_tdk.html";i:1553062603;s:83:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_navhead.html";i:1556096521;s:84:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_graduate.html";i:1554189547;s:82:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_bottom.html";i:1556096531;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<meta name="shenma-site-verification" content="60cb3d48af49fea76b809fd89a870ef9_1532595802"> 
		...
		<!-- 当前网页样式 --> 
		<link rel="stylesheet" href="/static/home/css/apply/graduate_student.css">
	...
	$('.topNavBox .ss .input button').click(function(){
		...
		<div class="gWidth1170 YjsSq">
			...
			<div class="content clearfix">
				<div class="fl div1">
					<h3><span id="span1">1000</span>+</h3>
					<p>常春藤院校全覆盖</p>
				</div>
				<div class="fl div2">
					<h3><span id="span2">300</span>+</h3>
					<p>TOP10名校录取人数</p>
				</div>
				<div class="fl div3">
					<h3><span id="span3">2000</span>+</h3>
					<p>TOP50名校录取人数</p>
				</div>
				<div class="fl div4">
					<h3><span id="span4">99.7</span>%</h3>
					<p>学生获得心仪学校Offer</p>
				</div>
				<div class="fl div5">
					<h3><span id="span5">53</span>%</h3>
					<p>Top10名校，彬彬教育占中国大陆录取名额53%</p>
				</div>
				<div class="fl div6">
					<h3><span id="span6">9.7</span>亿+</h3>
					<p>奖学金累计（RMB）</p>
				</div>
			</div>
		</div>
				...
				<div class="content clearfix">
					<div class="fl">
						<div class="t">
							...
							<!-- <img src="/static/home/img/apply/graduate_student/icon1.png" alt=""> -->
						</div>
						<span></span>
						<p>业内强大的海外专业导师网络</p>
						<div class="hidden">
					...
					<div class="fl">
						<div class="t">
							...
							<!-- <img src="/static/home/img/apply/graduate_student/icon2.png" alt=""> -->
						</div>
						<span></span>
						<p>经验丰富的主申请导师团队</p>
						<div class="hidden">
							<div class="p">
								<p>1.全部5年以上的申请经验</p>
								<p>2.每位主申请导师累计辅导学生500+</p>
								<p>3.总计收获美国知名高校录取 Offer 10000+</p>
								<p>4.全程陪伴贴心指导</p>
							</div>
						</div>
					</div>
					<div class="fl">
						<div class="t">
							...
							<!-- <img src="/static/home/img/apply/graduate_student/icon3.png" alt=""> -->
						</div>
						<span></span>
						<p>申请大数据库和背景提升资源库</p>
						<div class="hidden">
							<div class="p">
								<p>1.上千名校录取 Offer 案例数据库</p>
								<p>2.近千场线上线下公益专业讲座</p>
								<p>3.500强、独角兽、NGO等实习和课外活动资源库</p>
							</div>
						</div>
					</div>
					<div class="fl">
						<div class="t">
							...
							<!-- <img src="/static/home/img/apply/graduate_student/icon4.png" alt=""> -->
						</div>
						<span></span>
						<p>资深外籍导师团队</p>
						<div class="hidden">
							<div class="p">
								<p>1.均毕业于美国名校，曾从事学校招生、教育等相关工作</p>
								<p>2.全部为 Native Speakers，均有数年文书写作辅导经历</p>
								<p>3.累计修改各类项目文书上万篇</p>
							</div>
						</div>
					</div>
					<div class="fl">
						<div class="t">
							...
							<!-- <img src="/static/home/img/apply/graduate_student/icon5.png" alt=""> -->
						</div>
						<span></span>
						<p>以学生为中心的设计理念和全部可视化的服务流程</p>
						<div class="hidden">
							<div class="p">
								<p>1.学生满意度第一的理念，清晰的学生服务节点管理流程</p>
								<p>2.公开透明的网申系统</p>
								<p>3.高效及时的咨询反馈</p>
								<p>4.行业独有的督导体系</p>
							</div>
					...
					<div class="fr">
						<ul>
							<li class="li1 clearfix">
								<h3>资深流程导师</h3>
								<p class="fr">网申填写辅导、成绩认证辅导、语言成绩寄送辅导、申请材料准备辅导</p>
							</li>
		...
		<!-- 细致入微的导师服务体验 -->
		<div class="gWidth1170 fuwu_tiyan">
			<!-- title -->
			<div class="title">
				<h3>专业化精准导师服务体验</h3>
			</div>
			...
			<div class="gWidth1170">
				...
				<div class="offerBox">
					...
					<div class="content clearfix">
						...
						<!-- <div class="fl">
							<img class="fl" src="/static/home/img/apply/graduate_student/logo1.png" alt="">
							<img src="/static/home/img/apply/graduate_student/yuanxiao1.png" class="img" alt="">
							<div class="fr">
				...
				<div class="Jybox">
					...
					<div class="content clearfix">
						<!-- 左选项 -->
						<div class="fl cleft">
							<?php if(is_array($initials_arr) || $initials_arr instanceof \think\Collection || $initials_arr instanceof \think\Paginator): $i = 0; $__LIST__ = $initials_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;if($key == '0'): ?>
								<h3 class="fl active"><?php echo htmlentities($val); ?></h3>
							<?php else: ?>
								<h3 class="fl"><?php echo htmlentities($val); ?></h3>
							<?php endif; endforeach; endif; else: echo "" ;endif; ?>
						</div>
						<!-- 右内容 -->
						...
						<?php if(is_array($case_list) || $case_list instanceof \think\Collection || $case_list instanceof \think\Paginator): $i = 0; $__LIST__ = $case_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
							<div class="fr cright">
								<h3 class="fl"><?php echo htmlentities($val['initials']); ?></h3>
								<div class="fl">
									<div class="t">
										<p>同学</p>
										<p><span>本科：<?php echo htmlentities($val['school_name']); ?> </span><span><?php echo htmlentities($val['score']); ?></span></p>
									</div>
									<div class="b">
										<h4>实习经历</h4>
										<span>
										...
										<h4 style="margin-top: 10px;">录取院校</h4>
										<p><?php echo htmlentities($val['xx_name']); ?><span>/</span><?php echo htmlentities($val['xx_major']); ?><span><?php if(!(empty($val['xx_degree']) || (($val['xx_degree'] instanceof \think\Collection || $val['xx_degree'] instanceof \think\Paginator ) && $val['xx_degree']->isEmpty()))): ?>/</span><?php echo htmlentities($val['xx_degree']); ?></p><?php endif; ?>
										<p><img src="<?php echo htmlentities($val['xx_offer']); ?>" alt="<?php echo htmlentities($val['xx_name']); ?>录取通知书" title="<?php echo htmlentities($val['xx_name']); ?>录取通知书"></p>
										<h4>案例简介</h4>
										<p class="anli_jianjie"><?=$val['case_introduction_small']?></p>
									</div>
								</div>
								<a href="/success/<?php echo htmlentities($val['id']); ?>.html" target="_blank">详情&gt;&gt;</a>
							</div>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						...
						<!-- <div class="fr cright">
							...
							<div class="fl">
								<div class="t">
									<p>同学L</p>
									<p><span>本科：清华大学，英语</span><span>TOEFL： 108</span>GRE ：319</p>
								</div>
								<div class="b">
									<h4>实习经历</h4>
									<ul>
										<li>1. An Overview of PhD Student Elimination Systems in World-Class Universities with Instances of Linguistics Programs</li>
										<li>2. WeChat Emoticon “Smile” and Speech Communities</li>
										<li>3. IELTS Research Project with a Focus on Formulaic Language</li>
									</ul>
									<h4>录取院校</h4>
									<p>哥伦比亚大学<span>/</span>理论和应用语言学<span>/</span>Master</p>
									<img src="/static/home/img/apply/graduate_student/offer1.png" alt="">
									<p class="p">大一的时候我就早早下定了出国深造的决心，原因有二，其一是因为计算机专业的特殊性，其二是弥补我本科没能出国的遗憾。本科期间学的就是计算机，所以很看好这个专业。因此一开始就决定申请留学以及具体的方向。大一的时候我就早早下定了出国深造的决心，原因有二，其一是因为计算机专业的特殊性算机专业的特殊性算机专业的特殊性算机专业的特殊性算机专业的特殊性</p><a href="javascipt: false;">详情&gt;&gt;</a>
								</div>
							</div>
						</div>
						<div class="fr cright">
		...
		<div class="bjts_xiangmu gWidth1170">
			...
			<div class="title">
				<h3>全维度高品质背景提升项目</h3>
				<p>500强、独角兽、NGO等实习和课外活动资源库可为学生申请打造独一无二的优势</p>
			</div>
			<!-- content -->
			<div class="content">
				<!-- 选项 -->
				<div class="clearfix t">
					<div class="tbox">
						<?php if(is_array($bj_list) || $bj_list instanceof \think\Collection || $bj_list instanceof \think\Paginator): $i = 0; $__LIST__ = $bj_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;
								if($key==0){
								?>
									<a class="fl active"><?php echo htmlentities($val['pro_title']); ?></a><span class="fl">|</span>
								<?php	
								}else if($key==count($bj_list)-1){
								?>
									<a class="fl"><?php echo htmlentities($val['pro_title']); ?></a>
								<?php
								}else{
								?>
									<a class="fl"><?php echo htmlentities($val['pro_title']); ?></a><span class="fl">|</span>
								<?php
								}
				...
				<?php if(is_array($bj_list) || $bj_list instanceof \think\Collection || $bj_list instanceof \think\Paginator): $key1 = 0; $__LIST__ = $bj_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val1): $mod = ($key1 % 2 );++$key1;?>
						<div class="bcontent clearfix">
							<div class="fl">
								<?php if(is_array($val1['children']['hot']) || $val1['children']['hot'] instanceof \think\Collection || $val1['children']['hot'] instanceof \think\Paginator): $key2 = 0;$__LIST__ = is_array($val1['children']['hot']) ? array_slice($val1['children']['hot'],0,1, true) : $val1['children']['hot']->slice(0,1, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val2): $mod = ($key2 % 2 );++$key2;if($val2['is_hot'] == '1'): ?>
							...
							<a href="/project/0-<?php echo htmlentities($val1['id']); ?>-1.html" rel="nofollow" target="_blank" class="fr more">
								<span></span>
							</a>
						</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="news">
			<div class="box gWidth1170 clearfix">
				<!-- 讲座活动 -->
				<div class="fl bL">
					<h3><a href="/activity/3-0-1.html" target="_blank">讲座活动</a><a href="/activity/3-0-1.html" rel="nofollow" class="fr" target="_blank">MORE</a></h3>
					<div class="content">
						<?php if(is_array($activity_list) || $activity_list instanceof \think\Collection || $activity_list instanceof \think\Paginator): $i = 0; $__LIST__ = $activity_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
							<div class="clearfix">
								...
								<div class="fl cLeft">
									<h4><a href="/<?php echo htmlentities($val['rewrite']); ?>/<?php echo htmlentities($val['id']); ?>.html"><?php echo htmlentities($val['title']); ?></a></h4>
				...
				<!-- 美国本科留学资讯 -->
				<div class="fl bR">
					<h3><a href="/article/3-0-1.html" target="_blank">美国研究生留学资讯</a><a href="/article/3-0-1.html" rel="nofollow" class="fr" target="_blank">MORE</a></h3>
		...
		<!-- 当前网页js -->
		<script type="text/javascript" src="/static/home/js/apply/YanJs.js"></script>
		<!-- 底部 -->
