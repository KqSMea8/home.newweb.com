<?php /*a:5:{s:77:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\promote\bg_list.html";i:1555666743;s:80:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_head.html";i:1553677718;s:79:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_tdk.html";i:1553062603;s:83:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_navhead.html";i:1555494636;s:82:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_bottom.html";i:1555494636;}*/ ?>
 <!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<meta name="shenma-site-verification" content="60cb3d48af49fea76b809fd89a870ef9_1532595802"> 
		...
		<!-- 当前网页样式 -->
		<link rel="stylesheet" href="/static/home/css/promote/list.css">
		<!-- 分页样式 -->
...
<script type="text/javascript">
	...
	$('.topNavBox .ss .input button').click(function(){
		...
		<!-- banner -->
		<div class="banner">
			<img src="/static/home/img/promote/list/banner_1.png" alt="">
		</div>
		...
		<div class="shaiXuan gWidth1170">
			...
			<div class="m_nav clearfix">
				<a href="/">美国留学</a><span>&gt;</span><a href="/page/polymerization.html">背景提升</a>
			</div>
			<!-- 筛选项 -->
			<div class="x_x">
				<div class="x_box clearfix">
					...
					<div class="fl phase">
						<a href="/project/0-0-1.html" class="fl active">全部</a>
						<a href="/project/1-0-1.html" class="fl">高中</a>
						<a href="/project/2-0-1.html" class="fl">本科</a>
						<a href="/project/3-0-1.html" class="fl">研究生</a>
					</div>
				</div>
				<div class="x_box x_box2 clearfix">
					...
					<div class="fl">
						...
						<?php if(is_array($promote_type) || $promote_type instanceof \think\Collection || $promote_type instanceof \think\Paginator): $i = 0; $__LIST__ = $promote_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(in_array(($vo['id']), is_array($phase_type)?$phase_type:explode(',',$phase_type))): ?>
								<a href="<?php echo htmlentities($vo['id']); ?>" class="fl"><?php echo htmlentities($vo['bg_promote_type']); ?></a>
							<?php endif; endforeach; endif; else: echo "" ;endif; ?>
						<!-- <a href="" class="fl">申请规划</a>
						<a href="" class="fl">院校排名</a>
						<a href="" class="fl">择校指南</a>
						<a href="" class="fl">面试指导</a>
						<a href="" class="fl">留学费用</a>
						<a href="" class="fl">成功故事</a>
						<a href="" class="fl">背景提升案例</a> -->
					</div>
				</div>
			</div>
		</div>
		...
		<div class="listBox gWidth1170 clearfix">
			...
			<div class="fl list">
				...
				<div class="box clearfix">
					<div class="img clearfix">
						<img src="<?php echo config('admin_path');?><?php echo htmlentities($vo['thumbnail']); ?>" class="fl" alt="">
						<span><p><?php echo htmlentities($vo['bg_promote_type']); ?></p></span>
					</div>
					<div class="fr">
						<h3><a href="/<?php echo htmlentities($vo['rewrite']); ?>/<?php echo htmlentities($vo['id']); ?>.html" target="_blank"><?php echo htmlentities($vo['title']); ?></a></h3>
						<p><b>针对对象：</b><?php echo htmlentities($vo['target_object']); ?></p>
						<p><b>时间安排：</b><?php echo htmlentities($vo['activity_time']); ?></p>
					</div>
				</div>
				...
				<!-- <div class="page fr">
					<ul class="fl">
						<li class="fl"><a href="">上一页</a></li>
						<li class="fl active"><a href="">1</a></li>
						<li class="fl"><a href="">2</a></li>
						<li class="fl"><a href="">3</a></li>
						<li class="fl"><span>...</span></li>
						<li class="fl"><a href="">230</a></li>
						<li class="fl"><a href="">231</a></li>
						<li class="fl"><a href="">下一页</a></li>
					</ul>
					<div class="fl">
						<span>跳转：<input type="text" >页</span><button>确定</button>
					</div>
				</div> -->
			</div>
			<!-- 表单&&热门推荐 -->
			<div class="fr hotAndForm">
				...
				<div class="huodong_jz">
					<h3>背景提升案例</h3>
					<span></span>
					<?php if(is_array($case_bjts) || $case_bjts instanceof \think\Collection || $case_bjts instanceof \think\Paginator): $i = 0; $__LIST__ = $case_bjts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
					<div class="box clearfix">
						<div class="img">
							<img src="<?php echo htmlentities($val['cover_pic']); ?>" class="fl" alt="">
						</div>
						<div class="fr">
							<a href="/informationbjal/<?php echo htmlentities($val['id']); ?>.html" target="_blank"><?php echo htmlentities($val['title']); ?></a>
							<p><?php echo htmlentities($val['add_time']); ?></p>
						</div>
					</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<!-- 热门标签 -->
				<?php if(!(empty($label_list) || (($label_list instanceof \think\Collection || $label_list instanceof \think\Paginator ) && $label_list->isEmpty()))): ?>
				<div class="hot_bq">
					<h3>热门标签</h3>
					<span></span>
					<div class="box clearfix">
...
<script type="text/javascript">
	$(".label").click(function(){
		...
		<script type="text/javascript">
			...
			var listB = $('.listBox .list .box .img span p');
			
			listB.map(function (index, item) {
		...
		<script type="text/javascript">
			...
			if( urlHtml[0] == 0 ){ // 如果刚刚拆分的路径的 第一位是0 那么代表着 申请阶段为全部
				for( var i=0; i<aUrl.length; i++ ){ // 进行遍历,并挨个赋值路径.
					...
					aUrl.eq(i).attr('href', '/project/0-'+ type +'-1.html'); // 赋值路径
				}
			}else{ // 如果不是0 说明申请阶段 不是全部
				for( var i=0; i<aUrl.length; i++ ){
					aUrl.eq(i).removeClass('active');
					var type = aUrl.eq(i).attr('href'); // 获取id
					aUrl.eq(i).attr('href', '/project/'+ urlHtml[0] +'-'+ type +'-1.html'); // 赋值路径
				}
			}
			
			// 文章类型当前项
			if(urlHtml[0] == 0){
				sessionStorage.setItem('active', urlHtml[1]);
			}else{
			...
			for(var i=0; i<pageUrl.length; i++){
				...
				pageUrl.eq(i).attr('href', '/project/'+ pU[0] +'-'+ pU[1] +'-'+ page[1] +'.html')
			}
