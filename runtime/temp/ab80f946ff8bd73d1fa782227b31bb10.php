<?php /*a:5:{s:77:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\promote\content.html";i:1555038103;s:80:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_head.html";i:1553677718;s:79:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_tdk.html";i:1553062603;s:83:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_navhead.html";i:1555494636;s:82:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_bottom.html";i:1555494636;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<meta name="shenma-site-verification" content="60cb3d48af49fea76b809fd89a870ef9_1532595802"> 
		...
		<!-- 当前网页样式 -->
		<link rel="stylesheet" href="/static/home/css/promote/content.css">
	</head>
...
<script type="text/javascript">
	...
	$('.topNavBox .ss .input button').click(function(){
		...
		<!-- 面包屑导航 -->
		<div class="contentNav gWidth1170 clearfix">
			<a href="/" class="fl">美国留学</a><span class="fl">&gt;</span><a href="/page/polymerization.html" class="fl">背景提升</a><span class="fl">&gt;</span><a href="/project/0-<?php echo htmlentities($promote_list['id']); ?>-1.html" target="_blank" class="fl"><?php echo htmlentities($promote_list['bg_promote_type']); ?></a><span class="fl">&gt;</span><a class="fl"><?php echo htmlentities($promote_list['title']); ?></a>
		</div>
		
		<!-- 内容title -->
		<div class="contentTitle gWidth1170 clearfix">
			<div class="img fl">
				<img src="<?php echo config('admin_path');?><?php echo htmlentities($promote_list['thumbnail']); ?>" alt="">
			</div>
			<div class="box fr">
				<h3><?php echo htmlentities($promote_list['title']); ?></h3>
				<div class="clearfix">
					<span class="fl">项目地点：</span><p class="fl"><?php echo htmlentities($promote_list['project_location']); ?></p>
				</div>
				<div class="clearfix">
					<span class="fl">适合人群：</span><p class="fl"><?php echo htmlentities($promote_list['target_object']); ?></p>
				</div>
				<div class="clearfix">
					<span class="fl">项目时间：</span><p class="fl"><?php echo htmlentities($promote_list['activity_time']); ?></p>
				</div>
				<div class="clearfix">
					<a href="javascript:;" onclick="go()" class="fl">报名参加</a>
					<a href="javascript:;" onclick="go()" class="fl">在线咨询</a>
				</div>
			</div>
		</div>
		
		<!-- 内容content -->
		<div class="conContent clearfix gWidth1170">
			<!-- 左 -->
			<div class="conFl fl">
				<div class="conFlNav clearfix">
					<?php if(is_array($promote_list['content']) || $promote_list['content'] instanceof \think\Collection || $promote_list['content'] instanceof \think\Paginator): $i = 0; $__LIST__ = $promote_list['content'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$title_vo): $mod = ($i % 2 );++$i;?>
					<div class="fl">
						<a href="javascript:;"><?php echo htmlentities($title_vo['project_title']); ?></a>
					</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				
				<div class="conFlContent" id="conFlContent">
					<?php if(is_array($promote_list['content']) || $promote_list['content'] instanceof \think\Collection || $promote_list['content'] instanceof \think\Paginator): $i = 0; $__LIST__ = $promote_list['content'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$content_vo): $mod = ($i % 2 );++$i;?>
					<div>
						<h5><?php echo htmlentities($content_vo['project_title']); ?></h5>
						<p><?php echo $content_vo['project_content']; ?></p>
					</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
			</div>
			...
			<div class="conFr fl">
				<h3>更多推荐</h3>
				<span></span>
				<?php if(is_array($popular_info) || $popular_info instanceof \think\Collection || $popular_info instanceof \think\Paginator): $i = 0; $__LIST__ = $popular_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$popular_v): $mod = ($i % 2 );++$i;?>
				<div class="box clearfix">
					<img src="<?php echo config('admin_path');?><?php echo htmlentities($popular_v['thumbnail']); ?>" class="fl" alt="">
					<a href="/<?php echo htmlentities($popular_v['rewrite']); ?>/<?php echo htmlentities($popular_v['id']); ?>.html" class="fl"><?php echo htmlentities($popular_v['title']); ?></a>
				</div>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</div>
		</div>
...
<script type="text/javascript">
	$(".label").click(function(){
		...
		<script type="text/javascript" src="/static/home/js/promote/content.js"></script>
	</body>
