<?php /*a:5:{s:73:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\family\list.html";i:1552546187;s:80:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_head.html";i:1551955433;s:79:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_tdk.html";i:1551670345;s:83:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_navhead.html";i:1552618554;s:82:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_bottom.html";i:1552877332;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<script type="text/javascript">
		...
		<div class="shaiXuan gWidth1170">
			...
			<div class="m_nav clearfix">
				<a href="/">彬彬教育</a><span>&gt;</span><a>寄宿家庭</a>
			</div>
			<!-- 筛选项 -->
			<style type="text/css">
				.active{
			...
			<div class="x_x clearfix">
				...
				<?php if(!(empty($address_list) || (($address_list instanceof \think\Collection || $address_list instanceof \think\Paginator ) && $address_list->isEmpty()))): foreach($address_list as $key=>$vo): ?>
						<div class="fl">
							<?php if($vo['id'] == $state_id): ?>
								<a href="<?php echo htmlentities($vo['id']); ?>-1.html" class="fl active" data-id="<?php echo htmlentities($vo['id']); ?>"><em><?php echo htmlentities($vo['title']); if($vo['is_hot'] == '1'): ?><span></span><?php endif; ?></em></a>
								<?php else: ?>
								<a href="<?php echo htmlentities($vo['id']); ?>-1.html" class="fl" data-id="<?php echo htmlentities($vo['id']); ?>"><em><?php echo htmlentities($vo['title']); if($vo['is_hot'] == '1'): ?><span></span><?php endif; ?></em></a>
							<?php endif; ?>
						</div>
		...
		<div class="listBox gWidth1170 clearfix">
			<!-- 列表 -->
			<div class="fl list">
				<?php if(!(empty($list['data']) || (($list['data'] instanceof \think\Collection || $list['data'] instanceof \think\Paginator ) && $list['data']->isEmpty()))): if(is_array($list['data']) || $list['data'] instanceof \think\Collection || $list['data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
						<a href="/fmcontent/<?php echo htmlentities($val['id']); ?>.html">
							<div class="box clearfix">
								...
								<div class="fr">
									...
									<div class="clearfix fl">
											<a href="javascript:;"><?php echo htmlentities($val['s_title']); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;"><?php echo htmlentities($val['c_title']); ?></a>
									</div>
			...
			<div class="fr hotAndForm">
				...
				<div class="tuijian">
					<h3>高中名校推荐</h3>
					<span></span>
					<?php if(is_array($video_list) || $video_list instanceof \think\Collection || $video_list instanceof \think\Paginator): $i = 0; $__LIST__ = $video_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
						<div class="box" data-video="<?php echo htmlentities($val['video']); ?>">
							<a href="javascript:;">
								<img src="<?php echo htmlentities($val['cover_pic']); ?>" alt="<?php echo htmlentities($val['title']); ?>" title="<?php echo htmlentities($val['title']); ?>">
								<div class="poa">
