<?php /*a:5:{s:84:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\activity\activity_list.html";i:1555037972;s:80:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_head.html";i:1553677718;s:79:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_tdk.html";i:1553062603;s:83:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_navhead.html";i:1555494636;s:82:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_bottom.html";i:1555494636;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<script type="text/javascript">
	...
	$('.topNavBox .ss .input button').click(function(){
			...
			<div class="x_x">
				...
				<div class="x_box  x_box2 clearfix">
					...
					<div class="fl">
						...
						<?php if(is_array($activity_type) || $activity_type instanceof \think\Collection || $activity_type instanceof \think\Paginator): $i = 0; $__LIST__ = $activity_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(in_array(($vo['id']), is_array($phase_type)?$phase_type:explode(',',$phase_type))): ?>
								<a href="<?php echo htmlentities($vo['id']); ?>" class="fl"><?php echo htmlentities($vo['article_type']); ?></a>
		...
		<div class="listBox gWidth1170 clearfix">
			<!-- 列表 -->
			<div class="fl list">
				<?php if(is_array($activity_list) || $activity_list instanceof \think\Collection || $activity_list instanceof \think\Paginator): $i = 0; $__LIST__ = $activity_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<div class="box clearfix">
					<div class="img fl">
						<img src="<?php echo config('admin_path');?><?php echo htmlentities($vo['thumbnail']); ?>" class="fl" alt="<?php echo htmlentities($vo['title']); ?>" title="<?php echo htmlentities($vo['title']); ?>">
					</div>
					<div class="fr">
						<h3 style="margin-bottom: 25px;"><a href="/<?php echo htmlentities($vo['rewrite']); ?>/<?php echo htmlentities($vo['id']); ?>.html" target="_blank"><?php echo htmlentities($vo['title']); ?></a></h3>
						<div style="margin-bottom: 12px; font-size: 16px; color: #333333;">
							<b>讲座时间：</b><span><?php echo htmlentities($vo['lecture_time']); ?></span>
						</div>
						<div style="margin-bottom: 12px; font-size: 16px; color: #333333;">
							<b>讲座地点：</b><span><?php echo htmlentities($vo['lecture_venue']); ?></span>
						</div>
					</div>
			        <?php if($end_time[$key]['end'] == 1): ?>
					<!-- 报名显示 -->
			...
			<div class="fr hotAndForm">
				...
				<div class="bjts_tuijian">
					...
					<div class="box clearfix">
						<a href="/<?php echo htmlentities($promote_v['rewrite']); ?>/<?php echo htmlentities($promote_v['id']); ?>.html" rel="nofollow" class="fl"><img src="<?php echo config('admin_path');?><?php echo htmlentities($promote_v['thumbnail']); ?>" alt="<?php echo htmlentities($promote_v['title']); ?>" title="<?php echo htmlentities($promote_v['title']); ?>"></a>
				...
				<div class="anli">
					...
					<?php if(is_array($case_list) || $case_list instanceof \think\Collection || $case_list instanceof \think\Paginator): $i = 0; $__LIST__ = $case_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
						<p><a href="/success/<?php echo htmlentities($val['id']); ?>.html" target="_blank"><?php echo htmlentities($val['title']); ?></a></p>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<!-- 热门标签 -->
				<div class="hot_bq">
