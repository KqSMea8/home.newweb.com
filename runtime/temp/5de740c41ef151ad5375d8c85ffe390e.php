<?php /*a:5:{s:75:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\tutor\teacher.html";i:1555038209;s:80:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_head.html";i:1553677718;s:79:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_tdk.html";i:1553062603;s:83:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_navhead.html";i:1555494636;s:82:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_bottom.html";i:1555494636;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<script type="text/javascript">
	...
	$('.topNavBox .ss .input button').click(function(){
		...
		<div class="topBanner">
			<div class="gWidth1170 box">
				...
				<div class="clearfix Mbnav">
					...
					<a class="fl"><?php echo htmlentities($tutor_info['title']); ?></a>
				</div>
				<div class="xiangqing clearfix">
					<img src="<?php echo config('admin_path');?><?php echo htmlentities($tutor_info['details_portrait']); ?>" class="fl" alt="">
					<div class="fl">
						<h3><?php echo htmlentities($tutor_info['title']); ?></h3>
						<p><?php echo htmlentities($tutor_info['type']); ?></p>
						<span>擅长：<?php echo htmlentities($tutor_info['adept']); ?></span>
		...
		<div class="content gWidth1170">
			<?php if(!(empty($tutor_info['personal_profile']) || (($tutor_info['personal_profile'] instanceof \think\Collection || $tutor_info['personal_profile'] instanceof \think\Paginator ) && $tutor_info['personal_profile']->isEmpty()))): ?>
				<h3 class="title">个人简介<span></span></h3>
				<?php echo $tutor_info['personal_profile']; endif; if(!(empty($tutor_info['video']) || (($tutor_info['video'] instanceof \think\Collection || $tutor_info['video'] instanceof \think\Paginator ) && $tutor_info['video']->isEmpty()))): ?>
				<video src="<?php echo config('admin_path');?><?php echo htmlentities($tutor_info['video']); ?>"  poster="<?php echo config('admin_path');?><?php echo htmlentities($tutor_info['cover_pic']); ?>"  controls></video>
			<?php endif; if(!(empty($tutor_info['adept_field']) || (($tutor_info['adept_field'] instanceof \think\Collection || $tutor_info['adept_field'] instanceof \think\Paginator ) && $tutor_info['adept_field']->isEmpty()))): ?>
				<h3 class="title">擅长领域<span></span></h3>
				<?php echo $tutor_info['adept_field']; endif; if(!(empty($tutor_info['experience']) || (($tutor_info['experience'] instanceof \think\Collection || $tutor_info['experience'] instanceof \think\Paginator ) && $tutor_info['experience']->isEmpty()))): ?>
				<h3 class="title">服务心得<span></span></h3>
				<?php echo $tutor_info['experience']; endif; if(!(empty($tutor_info['student_evaluation']) || (($tutor_info['student_evaluation'] instanceof \think\Collection || $tutor_info['student_evaluation'] instanceof \think\Paginator ) && $tutor_info['student_evaluation']->isEmpty()))): ?>
				<h3 class="title">学生评价<span></span></h3>
				<?php echo $tutor_info['student_evaluation']; endif; if(!(empty($case_list) || (($case_list instanceof \think\Collection || $case_list instanceof \think\Paginator ) && $case_list->isEmpty()))): ?>
				...
				<?php if(is_array($case_list) || $case_list instanceof \think\Collection || $case_list instanceof \think\Paginator): $i = 0; $__LIST__ = $case_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
					<a href="/success/<?php echo htmlentities($val['id']); ?>.html">
						<div class="box fl">
							<div class="fl">
								<img src="<?php echo htmlentities($val['xx_logo']); ?>" alt="" style="margin-right: 20px;">
							</div>
							<div class="fl text">
								<h3><?php echo htmlentities($val['title']); ?></h3>
								<p><?php echo htmlentities($val['score']); ?><?php echo htmlentities($val['xx_name'][0]); ?></p>
							</div>
						</div>
					</a>
		...
		<!-- offer展示 -->
		<?php if(!(empty($offer_pic) || (($offer_pic instanceof \think\Collection || $offer_pic instanceof \think\Paginator ) && $offer_pic->isEmpty()))): ?>
		<div class="offerZs gWidth1170">
			<h3>offer展示<span></span></h3>
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<?php if(is_array($offer_pic) || $offer_pic instanceof \think\Collection || $offer_pic instanceof \think\Paginator): $i = 0; $__LIST__ = $offer_pic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<div class="swiper-slide">
						<img src="<?php echo config('admin_path');?><?php echo htmlentities($vo); ?>" alt="">
					</div>
