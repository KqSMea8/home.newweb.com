<?php /*a:5:{s:87:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\activity\activity_content.html";i:1555038648;s:80:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_head.html";i:1553677718;s:79:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_tdk.html";i:1553062603;s:83:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_navhead.html";i:1555494636;s:82:"E:\PHPTutorial\WWW\home.newweb.com\application\home\view\common\common_bottom.html";i:1555494636;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
<script type="text/javascript">
	...
	$('.topNavBox .ss .input button').click(function(){
		...
		<div class="mianbaoNav gWidth1170 clearfix">
			...
			<a href="/activity/1-<?php echo htmlentities($activity_info['type']); ?>-1.html" class="fl"><?php echo htmlentities($activity_info['article_type']); ?></a><span class="fl">&gt;</span>
			<a class="fl"><?php echo htmlentities($activity_info['title']); ?></a>
		</div>
		...
		<div class="content gWidth1170 clearfix">
			...
			<div class="fl boxL">
				<!-- title -->
				<div class="title">
					<h3><?php echo htmlentities($activity_info['title']); ?></h3>
					<p><?php echo htmlentities($activity_info['add_time']); ?> · 彬彬留学</p>
				</div>
				
				<!-- 活动信息 -->
				<div class="huodong_xinxi clearfix">
					<img src="<?php echo config('admin_path');?><?php echo htmlentities($activity_info['details_portrait']); ?>" class="fl" alt="">
					<div class="fl">
						<p><b>主讲人：</b><?php echo htmlentities($activity_info['name']); ?></p>
						<p><b>讲座时间：</b><?php echo htmlentities($activity_info['lecture_time']); ?></p>
						<p><b>讲座地点：</b><?php echo htmlentities($activity_info['lecture_venue']); ?></p>
						<p><b>活动类型：</b><?php echo htmlentities($activity_info['activity_type']); ?></p>
				...
				<!-- 嘉宾简介 -->
				<div class="jiabin">
					<?php echo $activity_info['activity_content']; ?>
				</div>
				
				<!-- 标签 -->
				<?php if(!(empty($activity_info['key_arr']) || (($activity_info['key_arr'] instanceof \think\Collection || $activity_info['key_arr'] instanceof \think\Paginator ) && $activity_info['key_arr']->isEmpty()))): ?>
					<p>标签：
						<?php if(is_array($activity_info['key_arr']) || $activity_info['key_arr'] instanceof \think\Collection || $activity_info['key_arr'] instanceof \think\Paginator): $i = 0; $__LIST__ = $activity_info['key_arr'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
							<a href="javascript:;"><?php echo htmlentities($val); ?></a>
				...
				<div class="bjts_tJ">
					...
					<div class="box clearfix">
						<a href="/<?php echo htmlentities($promote_v['rewrite']); ?>/<?php echo htmlentities($promote_v['id']); ?>.html" class="clearfix">
							<div class="img fl">
								<img src="<?php echo config('admin_path');?><?php echo htmlentities($promote_v['thumbnail']); ?>" alt="">
							</div>
							<div class="fr">
								<h3><?php echo htmlentities($promote_v['title']); ?></h3>
								<p> </p>
								<p>适合人群:　<?php echo htmlentities($promote_v['target_object']); ?></p>
							</div>
						</a>
					</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<div class="fr hotAndForm">
				...
				<div class="huodong_jz">
					<h3>热门活动讲座</h3>
					<span></span>
					<?php if(is_array($popular_list) || $popular_list instanceof \think\Collection || $popular_list instanceof \think\Paginator): $i = 0; $__LIST__ = $popular_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$popular_vo): $mod = ($i % 2 );++$i;?>
					<div class="box clearfix">
						<a href="/<?php echo htmlentities($popular_vo['rewrite']); ?>/<?php echo htmlentities($popular_vo['id']); ?>.html" rel="nofollow" class="fl"><img src="<?php echo config('admin_path');?><?php echo htmlentities($popular_vo['details_portrait']); ?>" alt=""></a>
						<div class="fr">
							<a href="/<?php echo htmlentities($popular_vo['rewrite']); ?>/<?php echo htmlentities($popular_vo['id']); ?>.html"><?php echo htmlentities($popular_vo['title']); ?></a>
							<p><?php echo htmlentities($popular_vo['lecture_time']); ?></p>
						</div>
					</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
