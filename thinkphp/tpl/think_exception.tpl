...
<html>
    ...
    <style type="text/css">
        .not{width: 100%;height: 879px;background: url(/static/home/img/beijing.jpg) no-repeat center center;background-size: cover;position: relative;}
        .not>div{width: 100%;position: absolute;bottom: 271px;text-align: center;}
        .not>div p{font-size: 22px;color: #000000;margin-bottom: 17px;}
        .not>div p span{font-size: 32px;color: #FF5B5A;vertical-align: middle;margin: 0 5px;margin-bottom: 5px;display: inline-block;}
        .not>div .anniu{text-align: center;font-size: 0;}
        .not>div .anniu a{display: inline-block;width: 182px;height: 52px;border: 1px solid #FF5B5A;border-radius: 30px;line-height: 52px;font-size: 22px;color: #FF5B5A;}
        .not>div .anniu a.a1{margin-left: 68px;}
        .not>div .anniu a:hover{background-color: #FF5B5A;color: #FFFFFF;}
    </style>
    <style type="text/css">
...
<div class="topNav clearfix">
    ...
    <div class="topNavBox clearfix">
        ...
        <div class="nav fl">
            ...
            <div class="fl">
                <a href="/middle/" target="_blank">美国高中</a>
                <div class="box">
                    <div>
                        <h3>我要申请</h3>
...
<style type="text/css">
    .abcBannav{
        ...
        <div class="not">
            <div>
                <p>“页面找不到了。别担心，他可能公费去了美国，不如先返回首页再试试？”</p>
                <p>页面<span>5</span>秒后返回首页！</p>
                <div class="anniu">
                    <a href="/">返回首页</a>
...
<!-- 底部 -->
<div class="bottomD" style="height: 670px;">
    <div class="bottomTop">
        <div class="gWidth1170 clearfix">
            ...
            <div class="fl logo">
                ...
                <p class="fl"><img src="/static/home/img/home/dianhua.png" class="fl" alt="">400-803-0017</p>
            </div>
            <!-- 底部导航 -->
            <div class="fl botNav">
...
<div class="goTop">
    ...
    <div class="dianhua"><img src="/static/home/img/dian_hua.png" alt=""><div onclick="go()">400-803-0017</div></div>
    <div class="shenqing"><img src="/static/home/img/shenqing.png" alt=""><div><h3>留学评估</h3><input type="text" class="name" placeholder="姓名"><input type="text" class="phone" placeholder="电话"><select class="nianji"><option value="">申请阶段</option><option value="0">高中</option><option value="1">本科</option><option value="2">研究生</option></select><button class="button1">免费评估</button></div></div>
...
<style type="text/css">
    ...
    .goTop div.shenqing div select{width: 98px;height: 26px;border: 1px solid #FFFFFF;display: block;margin: 0 auto;color: #FFFFFF;text-indent: 3px; opacity: 0.8;}
...
<script type="text/javascript" src="/static/home/js/index/public.js"></script>
        ...
        <script type="text/javascript">
            window.onload = function () {
                $('.not>div>.anniu').on('click', function () {
                    window.history.go(-1);
                })
                var time = 5;
