...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='广告分类';
...
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='后台管理员';
...
INSERT INTO `clt_admin` VALUES ('11', 'aaa', '47bce5c74f589f4867dbd57e9ca9f808', '2', '872723999@qq.com', '', '15145666666', '192.168.1.148', '1541574271', '0', '0', '/uploads/20181107/96e983a42a8d25f476ecf42ac082789f.jpg');
...
CREATE TABLE `clt_auth_rule` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=300 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限节点';
...
INSERT INTO `clt_auth_rule` VALUES ('23', 'Help/soft', '软件下载', '1', '1', '0', '', '', '22', '50', '1446711421', '0', '0');
...
INSERT INTO `clt_auth_rule` VALUES ('36', 'We/we_menu', '自定义菜单', '1', '1', '0', '', '', '35', '50', '1447842477', '0', '0');
...
INSERT INTO `clt_auth_rule` VALUES ('188', 'Plug/donation', '捐赠列表', '1', '1', '0', '', '', '187', '50', '1466563673', '0', '0');
...
-- -----------------------------
-- Table structure for `clt_wt_banner`
-- -----------------------------
DROP TABLE IF EXISTS `clt_wt_banner`;
CREATE TABLE `clt_wt_banner` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL COMMENT '图片标题',
  `describe` varchar(255) DEFAULT NULL COMMENT '图片描述',
  `img` varchar(255) DEFAULT NULL COMMENT '图片路劲',
  `url` varchar(255) DEFAULT NULL COMMENT '跳转地址',
  `is_show` tinyint(1) DEFAULT '1' COMMENT '1显示    0不显示',
...
-- -----------------------------
-- Records of `clt_wt_banner`
-- -----------------------------
INSERT INTO `clt_wt_banner` VALUES ('1', '我的风格', '我二哥', '/uploads/20181114/69d19fdd6ca78505305cf7753a6ab604.jpg', 'sdfghjk', '1', '3', '2345678');
INSERT INTO `clt_wt_banner` VALUES ('2', '的若反弹过后', '去的法国和', '/uploads/20181114/ae8be08bb4e379d4fd342d10d5f989c6.jpg', '分工会尽快', '1', '4', '23456');
INSERT INTO `clt_wt_banner` VALUES ('3', 'sdfgh', 'fhdh', '/uploads/20181114/c67995670913a9dfb5724838f21964dd.jpg', 'jfy', '1', '22', '1542175665');
INSERT INTO `clt_wt_banner` VALUES ('4', 'efegr', 'rgrtggh', '/uploads/20181114/8e72686e4c7a04094bc94902ad2a784b.jpg', 'gtdh', '1', '11', '1542175787');

-- -----------------------------
-- Table structure for `clt_wt_collection`
-- -----------------------------
DROP TABLE IF EXISTS `clt_wt_collection`;
CREATE TABLE `clt_wt_collection` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `resources_id` int(11) DEFAULT NULL COMMENT '资源id',
  `create_time` int(10) DEFAULT NULL COMMENT '收藏时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='小程序收藏表';

-- -----------------------------
-- Records of `clt_wt_collection`
-- -----------------------------
INSERT INTO `clt_wt_collection` VALUES ('4', '1', '6', '1542074314');
INSERT INTO `clt_wt_collection` VALUES ('5', '2', '8', '1542074426');
INSERT INTO `clt_wt_collection` VALUES ('6', '3', '8', '1542074439');
INSERT INTO `clt_wt_collection` VALUES ('8', '23', '11', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('9', '23', '12', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('10', '23', '13', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('11', '23', '14', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('12', '23', '15', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('13', '23', '16', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('14', '23', '17', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('15', '23', '18', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('16', '23', '19', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('17', '23', '20', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('18', '23', '21', '1542333509');
INSERT INTO `clt_wt_collection` VALUES ('50', '21', '9', '1542362704');
INSERT INTO `clt_wt_collection` VALUES ('51', '21', '10', '1542362705');
INSERT INTO `clt_wt_collection` VALUES ('53', '21', '18', '1542364185');
INSERT INTO `clt_wt_collection` VALUES ('54', '24', '14', '1542372413');
INSERT INTO `clt_wt_collection` VALUES ('60', '24', '6', '1542441657');
INSERT INTO `clt_wt_collection` VALUES ('61', '24', '9', '1542441690');
INSERT INTO `clt_wt_collection` VALUES ('62', '24', '10', '1542441692');
INSERT INTO `clt_wt_collection` VALUES ('66', '21', '0', '1542444572');
INSERT INTO `clt_wt_collection` VALUES ('67', '21', '22', '1542444703');
INSERT INTO `clt_wt_collection` VALUES ('68', '23', '6', '1542713682');

-- -----------------------------
-- Table structure for `clt_wt_help`
-- -----------------------------
DROP TABLE IF EXISTS `clt_wt_help`;
CREATE TABLE `clt_wt_help` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT '用户id(分享人)',
  `resources_id` int(11) DEFAULT NULL COMMENT '资源id',
  `help_user_openid` varchar(50) DEFAULT NULL COMMENT '助力人openid',
  `create_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='助力表';

-- -----------------------------
-- Records of `clt_wt_help`
-- -----------------------------
INSERT INTO `clt_wt_help` VALUES ('14', '24', '9', 'oPskb5KwBiqR3rLKjyLkCc9Yocms', '1542441602');
INSERT INTO `clt_wt_help` VALUES ('15', '21', '6', 'oPskb5FhJlcvqo5g5BsR3SkFf3aw', '1542446025');
INSERT INTO `clt_wt_help` VALUES ('16', '21', '6', 'oPskb5DFTIP-eLJvpbiytWdkEi_s', '1542446387');
INSERT INTO `clt_wt_help` VALUES ('17', '21', '11', 'oPskb5DFTIP-eLJvpbiytWdkEi_s', '1542447861');
INSERT INTO `clt_wt_help` VALUES ('18', '21', '11', 'oPskb5FhJlcvqo5g5BsR3SkFf3aw', '1542447867');
INSERT INTO `clt_wt_help` VALUES ('19', '26', '8', 'oPskb5DFTIP-eLJvpbiytWdkEi_s', '1542447921');
INSERT INTO `clt_wt_help` VALUES ('20', '26', '8', 'oPskb5FhJlcvqo5g5BsR3SkFf3aw', '1542447929');
INSERT INTO `clt_wt_help` VALUES ('21', '21', '7', 'oPskb5DFTIP-eLJvpbiytWdkEi_s', '1542448421');
INSERT INTO `clt_wt_help` VALUES ('22', '21', '23', 'oPskb5DFTIP-eLJvpbiytWdkEi_s', '1542448627');
INSERT INTO `clt_wt_help` VALUES ('23', '21', '23', 'oPskb5KgkrQzBxPlBqPCXAa5YDZg', '1542448663');
INSERT INTO `clt_wt_help` VALUES ('24', '21', '7', 'oPskb5KgkrQzBxPlBqPCXAa5YDZg', '1542448757');

-- -----------------------------
-- Table structure for `clt_wt_order`
-- -----------------------------
DROP TABLE IF EXISTS `clt_wt_order`;
CREATE TABLE `clt_wt_order` (
  `id` varchar(32) NOT NULL,
  `resources_id` int(11) DEFAULT NULL COMMENT '资源id',
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `status` tinyint(1) DEFAULT NULL COMMENT '0、未付款，1、已付款(付款金额不足)，2、已完成',
...
-- -----------------------------
-- Records of `clt_wt_order`
-- -----------------------------
INSERT INTO `clt_wt_order` VALUES ('88', '31', '28', '1', '0', '', '1542714784');
INSERT INTO `clt_wt_order` VALUES ('d754a6538527c563f8420ef9a728c281', '31', '26', '1', '0', '', '1542716844');

-- -----------------------------
-- Table structure for `clt_wt_resources`
-- -----------------------------
DROP TABLE IF EXISTS `clt_wt_resources`;
CREATE TABLE `clt_wt_resources` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cover_pic` varchar(255) DEFAULT NULL COMMENT '封面图片',
  `title` varchar(100) DEFAULT NULL COMMENT '标题',
  `lead` varchar(30) DEFAULT NULL COMMENT '主角（讲述人)',
  `describe` text COMMENT '描述',
  `is_price` tinyint(1) DEFAULT '1' COMMENT '预留：是否需要付钱，1、是，0，否',
  `is_share` tinyint(1) DEFAULT '1' COMMENT '预留：是否允许分享，1、是，0，否',
  `price` decimal(10,2) DEFAULT '0.00' COMMENT '价格',
  `sort` tinyint(5) DEFAULT '0' COMMENT '排序',
  `create_time` int(10) DEFAULT NULL COMMENT '添加时间',
  `type` tinyint(1) DEFAULT '1' COMMENT '类型1、音频，2、视频',
  `url` varchar(255) DEFAULT NULL COMMENT '资源地址',
  `status` tinyint(1) DEFAULT '1' COMMENT '状态：1、上架，0、下架',
  `restrictions` tinyint(5) DEFAULT '5' COMMENT '分享限制次数  默认 5',
  `update_time` int(10) DEFAULT NULL COMMENT '修改时间',
  `kuai_url` varchar(255) DEFAULT NULL COMMENT '腾讯云url',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='小程序资源表';

-- -----------------------------
-- Records of `clt_wt_resources`
-- -----------------------------
INSERT INTO `clt_wt_resources` VALUES ('6', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '111111', '1111', '111111111111', '1', '1', '0.01', '56', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '1542185550', '');
INSERT INTO `clt_wt_resources` VALUES ('7', '/uploads/20181115/76bd38ad66820a7e048966e49972e865.jpg', '2222', '22222222222', '22222222222', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542248520', '');
INSERT INTO `clt_wt_resources` VALUES ('8', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '3333333333333', '333333333333', '33333333333', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542185704', '');
INSERT INTO `clt_wt_resources` VALUES ('9', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '长安街一套房', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '', '');
INSERT INTO `clt_wt_resources` VALUES ('10', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '资源10', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '', '');
INSERT INTO `clt_wt_resources` VALUES ('11', '/uploads/20181114/386023087ac723ef2f3902277b547a0b.jpg', '资源11', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '1542164284', '');
INSERT INTO `clt_wt_resources` VALUES ('12', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '资源12', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '', '');
INSERT INTO `clt_wt_resources` VALUES ('13', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '资源13', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '', '');
INSERT INTO `clt_wt_resources` VALUES ('14', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '资源14', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '', '');
INSERT INTO `clt_wt_resources` VALUES ('15', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '资源15', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '', '');
INSERT INTO `clt_wt_resources` VALUES ('16', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '资源16', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '', '');
INSERT INTO `clt_wt_resources` VALUES ('17', '/uploads/20181114/05fd78834e8f69a633ee6a5dbe326d74.jpg', '资源17', '1111', '111111111111', '1', '1', '0.01', '5', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '1542160093', '');
INSERT INTO `clt_wt_resources` VALUES ('18', '/uploads/20181113/d7ee219c9f9504dd2442f0d25522b666.jpg', '资源18', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181114/b714c72a54f87d4dba72c52c5384cd9d.mp3', '1', '2', '1542160718', '');
INSERT INTO `clt_wt_resources` VALUES ('19', '/uploads/20181113/d7ee219c9f9504dd2442f0d25522b666.jpg', '资源19', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '', '');
INSERT INTO `clt_wt_resources` VALUES ('20', '/uploads/20181113/d7ee219c9f9504dd2442f0d25522b666.jpg', '资源20', '1111', '111111111111', '1', '1', '0.01', '50', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '', '');
INSERT INTO `clt_wt_resources` VALUES ('21', '/uploads/20181113/d7ee219c9f9504dd2442f0d25522b666.jpg', '蒂尼送给你1', '丁许峰', '覅而员工撒更方便苏啪啪则', '1', '1', '0.01', '4', '', '1', '/uploads/20181113/206d672ac5b413ee64d5948f070edaf3.mp3', '1', '2', '1542185588', '');
INSERT INTO `clt_wt_resources` VALUES ('22', '/uploads/20181115/76bd38ad66820a7e048966e49972e865.jpg', '数据1', '22222222222', '22222222222', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542248520', '');
INSERT INTO `clt_wt_resources` VALUES ('23', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '数据2', '333333333333', '33333333333', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542185704', '');
INSERT INTO `clt_wt_resources` VALUES ('24', '/uploads/20181115/76bd38ad66820a7e048966e49972e865.jpg', '数据3', '22222222222', '22222222222', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542248520', '');
INSERT INTO `clt_wt_resources` VALUES ('25', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '数据4', '333333333333', '33333333333', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542185704', '');
INSERT INTO `clt_wt_resources` VALUES ('26', '/uploads/20181115/76bd38ad66820a7e048966e49972e865.jpg', '数据5', '22222222222', '22222222222', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542248520', '');
INSERT INTO `clt_wt_resources` VALUES ('27', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '数据6', '333333333333', '33333333333', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542185704', '');
INSERT INTO `clt_wt_resources` VALUES ('28', '/uploads/20181115/76bd38ad66820a7e048966e49972e865.jpg', '数据7', '22222222222', '22222222222', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542248520', '');
INSERT INTO `clt_wt_resources` VALUES ('29', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '数据8', '333333333333', '33333333333', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542185704', '');
INSERT INTO `clt_wt_resources` VALUES ('30', '/uploads/20181115/76bd38ad66820a7e048966e49972e865.jpg', '数据9', '22222222222', '22222222222', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542248520', '');
INSERT INTO `clt_wt_resources` VALUES ('31', '/uploads/20181110/ee200407ac8ade689c840ee4f7d4254e.png', '数据10', '333333333333', '33333333333', '1', '1', '0.01', '50', '', '2', '/uploads/20181110/84cd040cf618a7cf194515c28a694b9d.mp4', '1', '2', '1542185704', 'http://1256778600.vod2.myqcloud.com/6209e4d4vodtranscq1256778600/064464ee5285890783373229134/v.f10.mp4');

-- -----------------------------
-- Table structure for `clt_wt_share`
-- -----------------------------
DROP TABLE IF EXISTS `clt_wt_share`;
CREATE TABLE `clt_wt_share` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT '分享人',
  `resources_id` int(11) DEFAULT NULL COMMENT '资源id',
  `create_time` int(10) DEFAULT NULL COMMENT '分享时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='分享表';

-- -----------------------------
-- Records of `clt_wt_share`
-- -----------------------------
INSERT INTO `clt_wt_share` VALUES ('3', '23', '15', '1542355287');
INSERT INTO `clt_wt_share` VALUES ('4', '21', '6', '1542371703');
INSERT INTO `clt_wt_share` VALUES ('5', '21', '6', '1542441307');
INSERT INTO `clt_wt_share` VALUES ('6', '21', '6', '1542441508');
INSERT INTO `clt_wt_share` VALUES ('7', '24', '9', '1542441590');
INSERT INTO `clt_wt_share` VALUES ('8', '21', '6', '1542445908');
INSERT INTO `clt_wt_share` VALUES ('9', '21', '6', '1542445918');
INSERT INTO `clt_wt_share` VALUES ('10', '21', '6', '1542445984');
INSERT INTO `clt_wt_share` VALUES ('11', '21', '6', '1542446003');
INSERT INTO `clt_wt_share` VALUES ('12', '21', '6', '1542446020');
INSERT INTO `clt_wt_share` VALUES ('13', '21', '6', '1542446047');
INSERT INTO `clt_wt_share` VALUES ('14', '21', '6', '1542446371');
INSERT INTO `clt_wt_share` VALUES ('15', '21', '6', '1542446381');
INSERT INTO `clt_wt_share` VALUES ('16', '21', '6', '1542446521');
INSERT INTO `clt_wt_share` VALUES ('17', '21', '6', '1542446983');
INSERT INTO `clt_wt_share` VALUES ('18', '21', '6', '1542446996');
INSERT INTO `clt_wt_share` VALUES ('19', '21', '11', '1542447834');
INSERT INTO `clt_wt_share` VALUES ('20', '21', '11', '1542447838');
INSERT INTO `clt_wt_share` VALUES ('21', '21', '8', '1542447912');
INSERT INTO `clt_wt_share` VALUES ('22', '21', '8', '1542447915');
INSERT INTO `clt_wt_share` VALUES ('23', '21', '7', '1542448410');
INSERT INTO `clt_wt_share` VALUES ('24', '21', '7', '1542448413');
INSERT INTO `clt_wt_share` VALUES ('25', '21', '23', '1542448605');
INSERT INTO `clt_wt_share` VALUES ('26', '21', '23', '1542448611');
INSERT INTO `clt_wt_share` VALUES ('27', '21', '7', '1542448722');
INSERT INTO `clt_wt_share` VALUES ('28', '21', '7', '1542448727');

-- -----------------------------
-- Table structure for `clt_wt_test`
-- -----------------------------
DROP TABLE IF EXISTS `clt_wt_test`;
CREATE TABLE `clt_wt_test` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------
-- Records of `clt_wt_test`
-- -----------------------------
INSERT INTO `clt_wt_test` VALUES ('2', 'oPskb5KwBiqR3rLKjyLkCc9Yocms');
INSERT INTO `clt_wt_test` VALUES ('3', '<xml>\n  <appid><![CDATA[wx2421b1c4370ec43b]]></appid>\n  <attach><![CDATA[支付测试]]></attach>\n  <bank_type><![CDATA[CFT]]></bank_type>\n  <fee_type><![CDATA[CNY]]></fee_type>\n  <is_subscribe><![CDATA[Y]]></is_subscribe>\n  <mch_id><![CDATA[10000100]]></mch_id>\n  <nonce_str><![CDATA[5d2b6c2a8db53831f7eda20af46e531c]]></nonce_str>\n  <openid><![CDATA[oUpF8uMEb4qRXf22hE3X68TekukE]]></openid>\n  <out_trade_no><![CDATA[1409811653]]></out_trade_no>\n  <result_code><![CDATA[SUCCESS]]></result_code>\n  <return_code><![CDATA[SUCCESS]]></return_code>\n  <sign><![CDATA[B552ED6B279343CB493C5DD0D78AB241]]></sign>\n  <sub_mch_id><![CDATA[10000100]]></sub_mch_id>\n  <time_end><![CDATA[20140903131540]]></time_end>\n  <total_fee>1</total_fee>\n<coupon_fee><![CDATA[10]]></coupon_fee>\n<coupon_count><![CDATA[1]]></coupon_count>\n<coupon_type><![CDATA[CASH]]></coupon_type>\n<coupon_id><![CDATA[10000]]></coupon_id>\n<coupon_fee><![CDATA[100]]></coupon_fee>\n  <trade_type><![CDATA[JSAPI]]></trade_type>\n  <transaction_id><![CDA');

-- -----------------------------
-- Table structure for `clt_wt_user`
-- -----------------------------
DROP TABLE IF EXISTS `clt_wt_user`;
CREATE TABLE `clt_wt_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `openid` varchar(50) DEFAULT NULL COMMENT '用户唯一标识',
  `mobile` varchar(13) DEFAULT NULL COMMENT '手机号',
  `nick_name` varchar(100) DEFAULT NULL COMMENT '用户昵称',
  `head_img` varchar(255) DEFAULT NULL COMMENT '头像',
  `create_time` int(10) DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='小程序用户表';

-- -----------------------------
-- Records of `clt_wt_user`
-- -----------------------------
INSERT INTO `clt_wt_user` VALUES ('26', 'oPskb5KgkrQzBxPlBqPCXAa5YDZg', '15145666573', '对方正在讲话...', 'https://wx.qlogo.cn/mmopen/vi_32/poo31O8Gibeupk6wFZFxcmggMuva18Tp3BdBL9ezthSX63Coy1tXlk3teaKjibpZCGGIpPXYicmlOkvtg9Gr3cbCA/132', '1542714652');
INSERT INTO `clt_wt_user` VALUES ('28', 'oPskb5KwBiqR3rLKjyLkCc9Yocms', '15176240239', 'A. 有媳妇,是个大傻子。', 'https://wx.qlogo.cn/mmopen/vi_32/qIjycuaz5Veog02jK0PIfq5y2icjSgMsoMxy3h3YIJo9YYcWFcNENsJibhtYkFYfiag64U5icYpDD5mYmrNRfbLrwQ/132', '1542714735');
...
CREATE TABLE `clt_wx_config` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=963 ROW_FORMAT=COMPACT COMMENT='第三方配置表';
...
INSERT INTO `clt_wx_menu` VALUES ('4', '0', '子菜单名称', '', '3', '1', '0', '', '0', '1', '1541484822', '0');
